    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh]">
        <div className="flex items-center justify-between p-4 border-b">
          <h3 className="text-lg font-semibold text-gray-900">Mi Perfil Culinario</h3>
        ...
        <div className="flex border-b border-gray-100 overflow-x-auto">
          <button 
            ...
            className={`flex-1 py-3 text-sm font-medium flex items-center justify-center gap-2 px-4 whitespace-nowrap transition-colors ${activeTab === 'preferences' ? 'text-primary border-b-2 border-primary bg-orange-50/50' : 'text-gray-500 hover:bg-gray-50'}`}
          >
          ...
          <button 
            ...
            className={`flex-1 py-3 text-sm font-medium flex items-center justify-center gap-2 px-4 whitespace-nowrap transition-colors ${activeTab === 'allergies' ? 'text-primary border-b-2 border-primary bg-orange-50/50' : 'text-gray-500 hover:bg-gray-50'}`}
          >
          ...
          <button 
            ...
            className={`flex-1 py-3 text-sm font-medium flex items-center justify-center gap-2 px-4 whitespace-nowrap transition-colors ${activeTab === 'utensils' ? 'text-primary border-b-2 border-primary bg-orange-50/50' : 'text-gray-500 hover:bg-gray-50'}`}
          >
          ...
          {activeTab === 'allergies' && (
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
              <div>
                ...
                <textarea
                  className="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary focus:border-transparent outline-none h-32 resize-none"
          ...
          {activeTab === 'utensils' && (
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
              ...
              <div className="pt-4 border-t border-gray-100">
                <label className="block text-sm font-medium text-gray-400 mb-2 cursor-not-allowed">
                  Utensilios Disponibles (Próximamente)
                </label>
                <div className="flex flex-wrap gap-2 opacity-50 pointer-events-none">
                  <span className="px-3 py-1 bg-gray-100 rounded-full text-xs">Batidora</span>
                  <span className="px-3 py-1 bg-gray-100 rounded-full text-xs">Horno</span>
                  <span className="px-3 py-1 bg-gray-100 rounded-full text-xs">Air Fryer</span>
                </div>
              </div>
            </div>
          )}
