...
import { signInWithEmail, signUpWithEmail, signInWithGoogle, upsertUserProfile, resetPassword } from '../services/supabase';
        ...
        <div className="mt-6 text-center">
          {isForgotPassword ? (
            <button
              ...
              className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary font-medium"
            >
